...
public class orderMenu {
	...
	public void temperature () {
		...
		System.out.println("뜨겁게 드시려면 1이상의 값을, 차갑게 드시려면 -1 이하의 값을 입력해주세요");
	...
	public void size () {
		...
		System.out.println("Small = 1, Medium = 2, Large = 3, 그외의 값 return size()");
		int size = sc.nextInt();
			if (size == 1) {
	...
	public void shot () {
		...
		System.out.println("양수의 값 샷추가 YES, 음수값 NO, 그 외의값 Return shot()");
		int shot = sc.nextInt();
